#include<stdio.h>
  #include<string.h>
    ...
    int twos[3*MAX+5]={0};
    int flip[3*MAX+5]={0};
    int c[100005]={0},d[100005]={0},sum[100005]={0},sums[300005]={0};
	...
	int q2 = query_tree(1+(node*2), (a+b)/2+1, b, i, j); // Query right child
...
int query_tr(int node, int a, int b, int i, int j) {
	...
	int q2 = query_tr(1+node*2, (a+b)/2+1, b, i, j); // Query right child
...
int query_tre(int node, int a, int b, int i, int j) {
	...
	int q2 = query_tre(1+(node*2), (a+b)/2+1, b, i, j); // Query right child
