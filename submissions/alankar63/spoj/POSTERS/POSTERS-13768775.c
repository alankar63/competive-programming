...
ll c[80004];
ll cd,id;
int BinarySearch(ll *array, int number_of_elements, ll key)
{
...
{ int i,j,k,t,n,w,r;
   ...
   ll ans[40004]={0},has[40004]={0};
      ...
      FOR(i,0,n)
      {
          w=BinarySearch(c,cd+1,a[i][0]);
          r=BinarySearch(c,cd+1,a[i][1]);
          FOR(j,w,r+1)
          {
              ans[j]=1+i;
          }
